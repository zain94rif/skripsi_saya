...
if (isset($_GET['id'])) {
	...
	$myQry3 = mysqli_query($koneksiDb, cekdataproduk($produk)) or die ("Query Salah : ".mysqli_error($koneksiDb));
	// echo cekrfidbuku2($buku);
	while($myData = mysqli_fetch_array($myQry3)){
...
$pesan = $nama_siswa." (".$id_siswa.") telah membeli ".$nama_makanan." seharga ".$harga_makanan." pada ".$tanggal;
