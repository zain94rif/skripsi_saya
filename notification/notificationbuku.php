...
if (isset($_GET['id'])) {
	...
	$myQry3 = mysqli_query($koneksiDb, cekrfidbuku2($buku)) or die ("Query Salah : ".mysqli_error($koneksiDb));
...
$pesan = $nama_siswa." (".$id_siswa.") telah meminjam buku ".$judul_buku." pada ".$tanggal;
