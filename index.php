<?php
  ...
  $namasekolah = "SMP Negeri 1 Kamal"
?>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?Open">
        ...
        <div class="sidebar-brand-text mx-3">Sistem Terpadu </div>
      </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="?Open=Logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
